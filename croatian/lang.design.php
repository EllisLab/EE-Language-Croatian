...
'Snippets are handy when you need small bits of reusable template or tag parts.  For static content that does not includeExpressionEngine tags, variables, or PHP, consider <a href =\'%s\'>Global Variables</a>.',
...
'If turned on, users from the allowed groups above will have to login via their username and password to view the template.',
